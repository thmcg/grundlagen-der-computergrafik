...
Cube::Cube(const Color &color)
{
    ...
    for (const auto &r : rotations)
    {
        ...
        vertices.emplace_back((r * Vector4(p1, 1)).xyz(), n, color);
        vertices.emplace_back((r * Vector4(p2, 1)).xyz(), n, color);
        vertices.emplace_back((r * Vector4(p3, 1)).xyz(), n, color);
        vertices.emplace_back((r * Vector4(p4, 1)).xyz(), n, color);
    }
}